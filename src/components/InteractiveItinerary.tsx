...
export default function InteractiveItinerary({ itinerary }: { itinerary: any }) {
  ...
  const handleGeneratePDF = async () => {
    ...
    try {
      ...
      // Force it to fit on exactly one page
      if (pdfHeight > pageHeight) {
        const ratio = pageHeight / pdfHeight;
        finalPdfHeight = pageHeight;
        finalPdfWidth = pdfWidth * ratio;
      }
  ...
  return (
    ...
    <div ref={pdfRef} className="w-full max-w-[900px] mx-auto mt-4 bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm flex flex-col">
      ...
      <div className="relative min-h-[420px] w-full bg-gradient-to-br from-orange-50 to-rose-50 overflow-hidden no-print border-b border-gray-100 flex flex-col md:flex-row">
        ...
        <div className="relative z-40 p-6 md:p-10 md:w-3/5 h-full flex flex-col justify-center">
          ...
          <div className="flex items-center gap-2 mb-4">
            <img src="/images/logos/logo.png" alt="Jongtour Logo" className="h-8 object-contain" crossOrigin="anonymous" />
          </div>
      ...
      {/* Footer / Export */}
      <div data-html2canvas-ignore="true" className="p-4 bg-gray-100 border-t border-gray-200 no-print flex justify-between items-center px-6">
      ...
      <div ref={shareCardRef} className="hidden w-[400px] bg-white text-gray-800 font-sans p-6 relative overflow-hidden" style={{ display: 'none' }}>
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-2 mb-6">
             <img src="/images/logos/logo.png" alt="Jongtour Logo" className="h-6 object-contain" crossOrigin="anonymous" />
          </div>
