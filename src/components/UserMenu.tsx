      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-72 bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden z-50 divide-y divide-gray-100 flex flex-col">
          ...
          <div className="py-2 flex flex-col">
            <Link href="/bookings" className="px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-between">
            ...
            <Link href="/rewards" className="px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-between">
              ...
              <span className="bg-[#5392f9] text-white text-[10px] px-2 py-0.5 rounded font-bold">฿ 0</span>
            </Link>
            <Link href="/vip" className="px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-between">
            ...
            <Link href="/profile" className="px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-between">
