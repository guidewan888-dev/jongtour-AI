      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-72 bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden z-50 divide-y divide-gray-100 flex flex-col">
          ...
          <div className="py-2 flex flex-col">
            ...
            <Link href="/account/bookings" className="px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-between">
              <span>รายการจอง</span>
            </Link>
            <Link href="/inbox" className="px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-between">
              <span>ข้อความจากทัวร์</span>
            </Link>
            <Link href="/account/dashboard" className="px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-between">
            ...
            <Link href="/account/favorites" className="px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-between">
              <span>ทัวร์ถูกใจ</span>
            </Link>
            <Link href="/account/dashboard" className="px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-between">
              <span>รีวิวของฉัน</span>
            </Link>
            <Link href="/account/profile" className="px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-between">
