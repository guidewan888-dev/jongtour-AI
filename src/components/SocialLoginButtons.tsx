  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <button 
        ...
        className="w-full flex items-center justify-center gap-3 bg-white text-[#1877F2] font-medium py-2.5 rounded-full border border-[#1877F2] hover:bg-blue-50 transition-colors shadow-sm"
      >
