...
export default function TourCard({ tour }: { tour: TourCardProps }) {
  ...
  return (
    ...
    >
      <div className="relative aspect-[3/4] overflow-hidden bg-white">
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent px-3 pb-2.5 pt-8">
          <div className="flex items-center gap-2 text-white text-[11px]">
            ...
            {tour.nextDeparture && tour.nextDeparture !== 'N/A' && (
              <>
                <span className="opacity-60">•</span>
      ...
      <div className="p-3.5">
        <h3 className="text-sm font-bold text-slate-900 group-hover:text-primary-600 transition-colors line-clamp-2 min-h-[2.5rem] leading-snug mb-2">
          {tour.title}
        </h3>
        <div className="flex items-center gap-1.5 mb-3 flex-wrap">
          ...
          {tour.pdfUrl && (
            <a
              ...
              className="inline-flex items-center gap-1 text-[10px] font-bold bg-green-50 text-green-600 px-2 py-0.5 rounded-full hover:bg-green-100"
            >
              📄 PDF
            </a>
          )}
        ...
        <div className="flex items-end justify-between pt-2.5 border-t border-slate-100">
            ...
            {tour.price > 0 ? (
              <>
                ...
                <p className="text-lg font-black text-primary-600 leading-tight">
                  ...
                  <span className="text-[10px] font-normal text-slate-400 ml-0.5">/ท่าน</span>
                </p>
              </>
            ) : (
          ...
          <span className="text-[10px] font-semibold text-primary-600 bg-primary-50 px-3 py-1.5 rounded-full group-hover:bg-primary-500 group-hover:text-white transition-all">
            ดูรายละเอียด
          </span>
        </div>
      </div>
