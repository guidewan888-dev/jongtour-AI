  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 pb-4 border-b border-slate-200">
        <div>
          <h1 className="text-2xl font-black text-slate-800">เชื่อมต่อบัญชี (Social Connections)</h1>
          <p className="text-slate-500 text-sm mt-1">จัดการการเข้าสู่ระบบผ่าน Google, LINE และ Facebook</p>
        </div>
      </div>
