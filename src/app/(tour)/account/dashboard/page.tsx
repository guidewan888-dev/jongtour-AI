  ...
  return (
    <div className="space-y-8 animate-fade-in-up">
      ...
      <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
        <div>
          <h1 className="text-2xl font-black text-slate-800 tracking-tight">เธชเธงเธฑเธชเธ”เธตเธเธธเธ“ {customer.firstName}!</h1>
          <p className="text-slate-500 font-medium">เธเธตเนเธเธทเธญเธ เธฒเธเธฃเธงเธกเธเธฒเธฃเธเธญเธเนเธฅเธฐเธ—เธฃเธดเธเธเธฒเธฃเน€เธ”เธดเธเธ—เธฒเธเธเธญเธเธเธธเธ“</p>
        </div>
        <Link href="/tours" className="bg-orange-500 hover:bg-orange-600 text-white px-5 py-2.5 rounded-xl text-sm font-bold shadow-sm transition-colors flex items-center justify-center gap-2 w-full md:w-auto">
          ...
          เธเนเธเธซเธฒเธ—เธฑเธงเธฃเนเนเธซเธกเน
        </Link>
      </div>
      ...
      {pendingPayments.length > 0 && (
        <div className="bg-red-50 border border-red-200 rounded-2xl p-6 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-black text-red-800 text-lg">เธฃเธฒเธขเธเธฒเธฃเธฃเธญเธเธณเธฃเธฐเน€เธเธดเธ</h3>
              <p className="text-red-600 text-sm font-medium mt-1">เธเธธเธ“เธกเธต {pendingPayments.length} เธฃเธฒเธขเธเธฒเธฃเธ—เธตเนเธ•เนเธญเธเธเธณเธฃเธฐเน€เธเธดเธ (เธญเนเธฒเธเธญเธดเธ: {pendingPayments[0].bookingRef})</p>
            </div>
          </div>
      ...
      {activeVouchers.length > 0 && (
        <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-6 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-black text-emerald-800 text-lg">Voucher เธเธฃเนเธญเธกเนเธเนเธเธฒเธ</h3>
              <p className="text-emerald-700 text-sm font-medium mt-1">Voucher เธชเธณเธซเธฃเธฑเธ {activeVouchers[0].tourName} เธเธญเธเธเธธเธ“เธเธฃเนเธญเธกเธ”เธฒเธงเธเนเนเธซเธฅเธ”เนเธฅเนเธง</p>
            </div>
          </div>
          <Link href={`/account/vouchers`} className="bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-2.5 rounded-xl text-sm font-bold shadow-sm whitespace-nowrap w-full sm:w-auto text-center transition-colors">
            เธ”เธฒเธงเธเนเนเธซเธฅเธ” Voucher
          </Link>
        </div>
      )}
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between">
          <div className="text-sm font-bold text-slate-500 mb-2">เธเธญเธเธ—เธฑเนเธเธซเธกเธ”</div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-orange-100 shadow-sm flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="text-sm font-bold text-orange-600 mb-2">เธฃเธญเธเธณเธฃเธฐเน€เธเธดเธ</div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-amber-100 shadow-sm flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="text-sm font-bold text-amber-600 mb-2">เธฃเธญเธขเธทเธเธขเธฑเธ (Pending)</div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-emerald-100 shadow-sm flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="text-sm font-bold text-emerald-600 mb-2">เธขเธทเธเธขเธฑเธเนเธฅเนเธง (Confirmed)</div>
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-slate-50">
              <h2 className="font-black text-lg text-slate-800">เธ—เธฃเธดเธเธ—เธตเนเธเธณเธฅเธฑเธเธเธฐเธกเธฒเธ–เธถเธ (Upcoming)</h2>
            ...
            {nextTrip ? (
                ...
                <div className="p-6 flex-1 flex flex-col justify-center">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <Link href={`/account/bookings/${nextTrip.bookingRef}`} className="bg-slate-900 hover:bg-slate-800 text-white px-5 py-2.5 rounded-xl text-sm font-bold transition-colors text-center w-full shadow-sm">
                      เธ”เธนเธฃเธฒเธขเธฅเธฐเน€เธญเธตเธขเธ”เธเธฒเธฃเธเธญเธ
                    </Link>
              ...
              <div className="p-12 text-center flex flex-col items-center">
                ...
                <h3 className="font-black text-slate-800 text-lg mb-1">เธขเธฑเธเนเธกเนเธกเธตเธ—เธฃเธดเธเธ—เธตเนเธเธณเธฅเธฑเธเธเธฐเธกเธฒเธ–เธถเธ</h3>
                <p className="text-slate-500 text-sm mb-6">เธญเธญเธเนเธเธเนเธเธซเธฒเธเธฃเธฐเธชเธเธเธฒเธฃเธ“เนเนเธซเธกเนเธเธฑเธเธ—เธฑเธงเธฃเนเธชเธธเธ”เธเธดเน€เธจเธฉเธเธฒเธ Jongtour</p>
                <Link href="/tours" className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-2.5 rounded-xl text-sm font-bold shadow-sm transition-colors">
                  เธ”เธนเธ—เธฑเธงเธฃเนเธ—เธฑเนเธเธซเธกเธ”
                </Link>
              </div>
            )}
          </div>
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="p-6 border-b border-slate-100">
              <h2 className="font-black text-lg text-slate-800">เธเธฒเธฃเน€เธเธฅเธทเนเธญเธเนเธซเธงเธฅเนเธฒเธชเธธเธ” (Recent Activity)</h2>
            </div>
            {recentActivities.length > 0 ? (
              <div className="divide-y divide-slate-100">
                {recentActivities.map(b => (
                  <div key={b.id} className="p-4 sm:p-6 flex items-center gap-4 hover:bg-slate-50 transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-slate-500">Ref: {b.bookingRef} โ€ข {new Date(b.createdAt).toLocaleDateString('th-TH')}</p>
                    </div>
               ...
               <div className="p-8 text-center text-slate-500 text-sm font-medium">เธขเธฑเธเนเธกเนเธกเธตเธเธฃเธฐเธงเธฑเธ•เธดเธเธฒเธฃเธ—เธณเธฃเธฒเธขเธเธฒเธฃ</div>
            )}
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-indigo-900 to-indigo-800 rounded-3xl p-6 shadow-md text-white relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <h3 className="font-black text-xl mb-2">เธกเธตเธเธณเธ–เธฒเธกเน€เธเธตเนเธขเธงเธเธฑเธเธ—เธฃเธดเธเนเธซเธก?</h3>
              <p className="text-indigo-200 text-sm mb-6 leading-relaxed">Jongtour Elite AI Planner เธเธฃเนเธญเธกเธเนเธงเธขเธเธธเธ“เธญเธญเธเนเธเธเธ—เธฃเธดเธเนเธฅเธฐเธ•เธญเธเธเธณเธ–เธฒเธก 24 เธเธก.</p>
              ...
              <div className="space-y-3">
                ...
                <Link href="/account/support" className="w-full bg-indigo-700 border border-indigo-500 text-white px-4 py-2.5 rounded-xl text-sm font-bold flex items-center justify-center gap-2 hover:bg-indigo-600 transition-colors">
                  เธ•เธดเธ”เธ•เนเธญเน€เธเนเธฒเธซเธเนเธฒเธ—เธตเน
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="p-5 border-b border-slate-100 flex items-center justify-between">
              <h3 className="font-black text-slate-800">เธ—เธฑเธงเธฃเนเธ—เธตเนเธเธฑเธเธ—เธถเธเนเธงเน</h3>
              <Link href="/account/favorites" className="text-xs font-bold text-orange-500 hover:underline">เธ”เธนเธ—เธฑเนเธเธซเธกเธ”</Link>
            </div>
            <div className="p-5 text-center text-slate-500 text-sm font-medium">
              ...
              เธเธธเธ“เธขเธฑเธเนเธกเนเธกเธตเธ—เธฑเธงเธฃเนเธ—เธตเนเธเธฑเธเธ—เธถเธเนเธงเน
            </div>
          </div>
