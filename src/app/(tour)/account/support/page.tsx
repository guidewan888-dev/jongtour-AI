...
export default async function CustomerSupportPage({ searchParams }: { searchParams: { topic?: string, ref?: string } }) {
  ...
  const getStatusBadge = (status: string) => {
    switch(status) {
      case 'OPEN': return <span className="bg-blue-100 text-blue-700 px-2.5 py-1 rounded-md text-[10px] font-black tracking-wider uppercase border border-blue-200">เธฃเธญเธ”เธณเน€เธเธดเธเธเธฒเธฃ (Open)</span>
      case 'IN_PROGRESS': return <span className="bg-orange-100 text-orange-700 px-2.5 py-1 rounded-md text-[10px] font-black tracking-wider uppercase border border-orange-200">เธเธณเธฅเธฑเธเธ•เธฃเธงเธเธชเธญเธ (In Progress)</span>
      case 'RESOLVED': return <span className="bg-emerald-100 text-emerald-700 px-2.5 py-1 rounded-md text-[10px] font-black tracking-wider uppercase border border-emerald-200">เนเธเนเนเธเนเธฅเนเธง (Resolved)</span>
      case 'CLOSED': return <span className="bg-slate-100 text-slate-600 px-2.5 py-1 rounded-md text-[10px] font-black tracking-wider uppercase border border-slate-200">เธเธดเธ”เธเธฒเธ (Closed)</span>
  ...
  const getPriorityBadge = (priority: string) => {
    ...
    return <span className="text-slate-400 font-bold text-xs uppercase tracking-wider">เธเธเธ•เธด</span>
  }
  ...
  return (
    <div className="space-y-8 animate-fade-in-up">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 pb-4 border-b border-slate-200">
        <div>
          <h1 className="text-2xl font-black text-slate-800">เธจเธนเธเธขเนเธเนเธงเธขเน€เธซเธฅเธทเธญ (Support)</h1>
          <p className="text-slate-500 text-sm mt-1">เธ•เธดเธ”เธ•เนเธญเน€เธเนเธฒเธซเธเนเธฒเธ—เธตเน เนเธเนเธเธเธฑเธเธซเธฒ เธซเธฃเธทเธญเธชเธญเธเธ–เธฒเธกเธเนเธญเธกเธนเธฅเน€เธเธดเนเธกเน€เธ•เธดเธก</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6 order-2 lg:order-1">
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-6 md:p-8 sticky top-24">
            <h2 className="text-lg font-black text-slate-800 mb-6 flex items-center gap-2">
               ...
               เน€เธเธดเธ” Ticket เนเธซเธกเน
            </h2>
        ...
        <div className="lg:col-span-2 order-1 lg:order-2">
          <h2 className="text-lg font-black text-slate-800 mb-4">เธเธฃเธฐเธงเธฑเธ•เธดเธเธฒเธฃเธ•เธดเธ”เธ•เนเธญเธเธญเธเธเธธเธ“</h2>
          ...
          {tickets.length > 0 ? (
                ...
                <Link href={`/account/support/${ticket.ticketNo}`} key={ticket.id} className="block bg-white border border-slate-200 rounded-2xl p-5 hover:border-indigo-300 transition-colors shadow-sm group">
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      ...
                      <h3 className="text-base font-black text-slate-800 group-hover:text-indigo-600 transition-colors">
                        {ticket.topic === 'tax_invoice' ? 'เธเธญเนเธเธเธณเธเธฑเธเธ เธฒเธฉเธตเน€เธ•เนเธกเธฃเธนเธเนเธเธ' : ticket.topic.replace('_', ' ').toUpperCase()}
                      </h3>
                      {ticket.bookingRef && (
                  ...
                  <div className="flex justify-between items-center text-xs text-slate-500 font-medium bg-slate-50 p-2.5 rounded-xl">
                    <span className="flex items-center gap-1">
                      เธญเธฑเธเน€เธ”เธ•เธฅเนเธฒเธชเธธเธ”: {new Date(ticket.updatedAt).toLocaleString('th-TH')}
                    </span>
                    <span className="text-indigo-500 font-bold flex items-center gap-1 group-hover:underline">
                      เธ”เธนเธเธ—เธชเธเธ—เธเธฒ &rarr;
                    </span>
                  </div>
                </Link>
              ))}
            ...
            <div className="bg-white border border-slate-200 rounded-3xl p-12 text-center shadow-sm flex flex-col items-center">
              ...
              <p className="text-slate-500 font-medium text-sm">เธขเธฑเธเนเธกเนเธกเธตเธเธฃเธฐเธงเธฑเธ•เธดเธเธฒเธฃเธ•เธดเธ”เธ•เนเธญ</p>
            </div>
          )}
        </div>
