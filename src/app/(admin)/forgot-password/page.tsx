...
export default function AdminForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!email || !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email)) {
      setError('เธเธฃเธธเธ“เธฒเธเธฃเธญเธเธญเธตเน€เธกเธฅเธ—เธตเนเธ–เธนเธเธ•เนเธญเธ');
      return;
    }
    ...
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col justify-center items-center p-4 font-sans text-slate-900">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 p-8 sm:p-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black tracking-tighter">เธฅเธทเธกเธฃเธซเธฑเธชเธเนเธฒเธ</h1>
          <p className="text-sm text-slate-500 mt-2">เธเธฃเธญเธเธญเธตเน€เธกเธฅเน€เธเธทเนเธญเธฃเธฑเธเธฅเธดเธเธเนเธฃเธตเน€เธเนเธ•เธฃเธซเธฑเธชเธเนเธฒเธ</p>
        </div>
        ...
        {success ? (
          <div className="text-center">
            ...
            <h2 className="text-lg font-bold text-slate-800 mb-2">เธชเนเธเธญเธตเน€เธกเธฅเน€เธฃเธตเธขเธเธฃเนเธญเธข</h2>
            <p className="text-sm text-slate-500 mb-6">เธเธฃเธธเธ“เธฒเธ•เธฃเธงเธเธชเธญเธเธญเธตเน€เธกเธฅ <strong>{email}</strong> เธชเธณเธซเธฃเธฑเธเธฅเธดเธเธเนเธฃเธตเน€เธเนเธ•เธฃเธซเธฑเธชเธเนเธฒเธ</p>
            <a href="/login" className="text-sm font-bold text-orange-600 hover:text-orange-700">โ เธเธฅเธฑเธเนเธเธซเธเนเธฒเน€เธเนเธฒเธชเธนเนเธฃเธฐเธเธ</a>
          </div>
        ) : (
          <>
            {error && (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button type="submit" disabled={isLoading} className="w-full bg-orange-600 hover:bg-orange-700 disabled:bg-slate-300 text-white font-bold py-3.5 rounded-xl transition-all shadow-md flex justify-center items-center">
                ...
                ) : 'เธชเนเธเธฅเธดเธเธเนเธฃเธตเน€เธเนเธ•เธฃเธซเธฑเธชเธเนเธฒเธ'}
              </button>
            </form>
