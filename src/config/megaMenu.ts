    ...
    columns: [
      {
        ...
        items: [
          ...
          { label: "ทัวร์เฉิงตู", href: "/country/china?city=เฉิงตู", emoji: "🏙️" },
          { label: "ทัวร์จางเจียเจี้ย", href: "/country/china?city=จางเจียเจี้ย", emoji: "🏔️" },
          { label: "ทัวร์คุนหมิง", href: "/country/china?city=คุนหมิง", emoji: "🌸" },
          { label: "ทัวร์ปักกิ่ง", href: "/country/china?city=ปักกิ่ง", emoji: "🏯" },
          { label: "ทัวร์เซี่ยงไฮ้", href: "/country/china?city=เซี่ยงไฮ้", emoji: "🌃" },
          { label: "ทัวร์กวางเจา", href: "/country/china?city=กวางเจา", emoji: "🏙️" },
          { label: "ทัวร์ญี่ปุ่น", href: "/country/japan", flagCode: "jp" },
          { label: "ทัวร์โตเกียว", href: "/country/japan?city=โตเกียว", emoji: "🗼" },
          { label: "ทัวร์โอซาก้า", href: "/country/japan?city=โอซาก้า", emoji: "🏯" },
          { label: "ทัวร์ฮอกไกโด", href: "/country/japan?city=ฮอกไกโด", emoji: "❄️" },
          { label: "ทัวร์เกียวโต", href: "/country/japan?city=เกียวโต", emoji: "⛩️" },
          { label: "ทัวร์ฟุกุโอกะ", href: "/country/japan?city=ฟุกุโอกะ", emoji: "🌊" },
      ...
      },
      {
        ...
        items: [
          ...
          { label: "ทัวร์โซล", href: "/country/south-korea?city=โซล", emoji: "🏙️" },
          { label: "ทัวร์ปูซาน", href: "/country/south-korea?city=ปูซาน", emoji: "🌊" },
          { label: "ทัวร์เชจู", href: "/country/south-korea?city=เชจู", emoji: "🏝️" },
          { label: "ทัวร์เวียดนาม", href: "/country/vietnam", flagCode: "vn" },
          { label: "ทัวร์ดานัง", href: "/country/vietnam?city=ดานัง", emoji: "🏖️" },
          { label: "ทัวร์ฮานอย", href: "/country/vietnam?city=ฮานอย", emoji: "🏙️" },
